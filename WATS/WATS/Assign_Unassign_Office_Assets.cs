...
namespace WATS
{
    public partial class Assign_Unassign_Office_Assets : Form
    {
        ...
        public Assign_Unassign_Office_Assets()
        {
            InitializeComponent();
        }

        private void Assign_Office_Asset_Button_Click(object sender, EventArgs e)
        {
            try
            {

                con.Open();
                SqlCommand cmd = new SqlCommand("UPDATE Office_Table SET Office_Asset_ID = @Enter_Office_Asset_ID WHERE Office_ID=@Enter_Office_ID", con);
                cmd.Parameters.AddWithValue("@Enter_Office_Asset_ID", int.Parse(Enter_Office_Asset_ID_Text_Box.Text));
                cmd.Parameters.AddWithValue("@Enter_Office_ID", int.Parse(Enter_Office_ID_Text_Box.Text));
                cmd.ExecuteNonQuery();
                MessageBox.Show("Office Asset Has Been Assigned!");
            }
        ...
        private void Show_Offices_Button_Click(object sender, EventArgs e)
        {
