...
namespace WATS
{
    public partial class Create_Inactivate_Employees : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("INSERT INTO Employee_Table (Employee_First_Name,Employee_Last_Name,Employee_Job_Title,Employee_Status,Office_ID,Employee_Email,Computer_Asset_ID)values(' " + Employee_First_Name_Text_Box.Text + " ', ' " + Employee_Last_Name_Text_Box.Text + " ', ' " + Employee_Job_Title_Combo_Box.Text + " ', ' " + Employee_Status_Combo_Box.Text + " ', ' " + Office_ID_Text_Box.Text + " ', ' " + Employee_Email_Text_Box.Text + " ', ' " + int.Parse(Computer_Asset_ID_Text_Box.Text) + " ')", con);
                cmd.ExecuteNonQuery();
        ...
        private void Inactivate_Employee_Button_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                SqlCommand cmd = new SqlCommand("UPDATE Employee_Table SET Employee_Status = 'INACTIVE' WHERE Employee_ID=@Employee_ID", con);
        ...
        private void Reactivate_Employee_Button_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                SqlCommand cmd = new SqlCommand("UPDATE Employee_Table SET Employee_Status = 'ACTIVE' WHERE Employee_ID=@Employee_ID", con);
                cmd.Parameters.AddWithValue("@Employee_ID", int.Parse(Employee_ID_Text_Box.Text));
                cmd.ExecuteNonQuery();
                MessageBox.Show("Updated");
            }
